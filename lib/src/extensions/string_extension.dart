...
extension StringExtension on String {
  ...
  String get capitalizeEachUpperLowerFirst =>
      this.split(" ").map((e) => e[0].toLowerCase() + e.substring(1)).join(" ").toUpperCase();
  ...
  String get filterNumberDecimalComma => this.replaceAll(RegExp(r"[^0-9,]"), "");
  ...
  String get forEachUpperLowerFirst =>
      this.split(" ").map((e) => e[0].toLowerCase() + e.substring(1)).join(" ").toUpperCase();
  String get forEachUpperLowerFirstUpper =>
      this.split(" ").map((e) => e[0].toUpperCase() + e.substring(1)).join(" ").toLowerCase();

  bool get isPhoneNumber => this.length == 11 && this.startsWith("0");
  bool get isPhoneNumberWithCountryCode => this.length == 13 && this.startsWith("+");
  bool get isPhoneNumberWithCountryCodeAndSpace => this.length == 14 && this.startsWith("+ ");
  ...
  bool get isDateTimeFormat => this.isDateTime && this.dateTime.toString().contains(" ");
  ...
  bool isSearch(String search) => this.trim().toLowerCase().contains(search.trim().toLowerCase());
